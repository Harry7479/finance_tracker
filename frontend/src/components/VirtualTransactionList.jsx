...
const READ_ONLY_GRID_LAYOUT = "110px 140px 100px 140px 1fr 120px";
  ...
  return (
    <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div 
        style={{ 
          display: 'grid', 
          gridTemplateColumns: isReadOnly ? READ_ONLY_GRID_LAYOUT : GRID_LAYOUT, 
          padding: '0 10px', 
          height: '40px', 
          alignItems: 'center',
      ...
      >
        ...
        {!isReadOnly && <span className="text-center">Actions</span>}
      </div>
